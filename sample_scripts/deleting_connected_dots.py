...
dots_kind_matrix_deleted = interface_dots.delete_connected_dots(dots_kind_matrix, connected_dots_list)

interface_dots.animate_dots_no_motion([dots_kind_matrix, dots_kind_matrix_deleted])
plt.show(block=False)

dots_kind_matrix_returned, _, _ = \
    interface_dots.delete_and_fall_dots(dots_kind_matrix, connected_dots_list, 4)
    
interface_dots.animate_dots_no_motion([dots_kind_matrix, dots_kind_matrix_deleted, dots_kind_matrix_returned])
plt.show(block=False)

dots_transition = interface_dots.delete_and_fall_dots_to_the_end(dots_kind_matrix, 4)
